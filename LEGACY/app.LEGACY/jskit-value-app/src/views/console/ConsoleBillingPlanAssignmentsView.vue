...
<script setup>
import { useConsoleBillingPlanAssignmentsView } from "./useConsoleBillingPlanAssignmentsView.js";

const { entries, queryPending, queryError, formatDate } = useConsoleBillingPlanAssignmentsView();
</script>
