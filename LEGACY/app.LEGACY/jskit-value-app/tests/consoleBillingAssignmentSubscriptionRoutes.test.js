...
test("console billing assignment and subscription routes expose typed query/params/body schemas", () => {
  ...
  const listAssignmentsRoute = routeMap.get("GET /api/console/billing/plan-assignments");
  ...
  const createAssignmentRoute = routeMap.get("POST /api/console/billing/plan-assignments");
  ...
  const updateAssignmentRoute = routeMap.get("PATCH /api/console/billing/plan-assignments/:assignmentId");
  ...
  const cancelAssignmentRoute = routeMap.get("POST /api/console/billing/plan-assignments/:assignmentId/cancel");
  ...
  const listSubscriptionsRoute = routeMap.get("GET /api/console/billing/subscriptions");
  ...
  const changePlanRoute = routeMap.get("POST /api/console/billing/subscriptions/:providerSubscriptionId/change-plan");
  ...
  const cancelSubscriptionRoute = routeMap.get("POST /api/console/billing/subscriptions/:providerSubscriptionId/cancel");
