...
function createApi({ request }) {
  return {
    ...
    listEntitlementDefinitions(query = {}) {
      ...
      const queryString = params.toString();
      return request(`/api/console/billing/entitlement-definitions${queryString ? `?${queryString}` : ""}`);
    },
    getEntitlementDefinition(definitionId) {
      const encodedDefinitionId = encodeURIComponent(String(definitionId || "").trim());
      return request(`/api/console/billing/entitlement-definitions/${encodedDefinitionId}`);
    },
    createEntitlementDefinition(payload, options = {}) {
      return request("/api/console/billing/entitlement-definitions", {
        method: "POST",
        body: payload,
    ...
    archiveBillingPlan(planId, payload = {}, options = {}) {
      const encodedPlanId = encodeURIComponent(String(planId || "").trim());
      return request(`/api/console/billing/plans/${encodedPlanId}/archive`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    unarchiveBillingPlan(planId, payload = {}, options = {}) {
      const encodedPlanId = encodeURIComponent(String(planId || "").trim());
      return request(`/api/console/billing/plans/${encodedPlanId}/unarchive`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    archiveBillingProduct(productId, payload = {}, options = {}) {
      const encodedProductId = encodeURIComponent(String(productId || "").trim());
      return request(`/api/console/billing/products/${encodedProductId}/archive`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    unarchiveBillingProduct(productId, payload = {}, options = {}) {
      const encodedProductId = encodeURIComponent(String(productId || "").trim());
      return request(`/api/console/billing/products/${encodedProductId}/unarchive`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    listPurchases(query = {}) {
      ...
      const queryString = params.toString();
      return request(`/api/console/billing/purchases${queryString ? `?${queryString}` : ""}`);
    },
    refundPurchase(purchaseId, payload = {}, options = {}) {
      const encodedPurchaseId = encodeURIComponent(String(purchaseId || "").trim());
      return request(`/api/console/billing/purchases/${encodedPurchaseId}/refund`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    voidPurchase(purchaseId, payload = {}, options = {}) {
      const encodedPurchaseId = encodeURIComponent(String(purchaseId || "").trim());
      return request(`/api/console/billing/purchases/${encodedPurchaseId}/void`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    createPurchaseCorrection(purchaseId, payload = {}, options = {}) {
      const encodedPurchaseId = encodeURIComponent(String(purchaseId || "").trim());
      return request(`/api/console/billing/purchases/${encodedPurchaseId}/corrections`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    listPlanAssignments(query = {}) {
      ...
      const queryString = params.toString();
      return request(`/api/console/billing/plan-assignments${queryString ? `?${queryString}` : ""}`);
    },
    createPlanAssignment(payload = {}, options = {}) {
      return request("/api/console/billing/plan-assignments", {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    updatePlanAssignment(assignmentId, payload = {}, options = {}) {
      ...
      return request(`/api/console/billing/plan-assignments/${encodedAssignmentId}`, {
        method: "PATCH",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    cancelPlanAssignment(assignmentId, payload = {}, options = {}) {
      const encodedAssignmentId = encodeURIComponent(String(assignmentId || "").trim());
      return request(`/api/console/billing/plan-assignments/${encodedAssignmentId}/cancel`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    listSubscriptions(query = {}) {
      ...
      const queryString = params.toString();
      return request(`/api/console/billing/subscriptions${queryString ? `?${queryString}` : ""}`);
    },
    changeSubscriptionPlan(providerSubscriptionId, payload = {}, options = {}) {
      ...
      return request(`/api/console/billing/subscriptions/${encodedSubscriptionId}/change-plan`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    cancelSubscription(providerSubscriptionId, payload = {}, options = {}) {
      const encodedSubscriptionId = encodeURIComponent(String(providerSubscriptionId || "").trim());
      return request(`/api/console/billing/subscriptions/${encodedSubscriptionId}/cancel`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
    ...
    cancelSubscriptionAtPeriodEnd(providerSubscriptionId, payload = {}, options = {}) {
      const encodedSubscriptionId = encodeURIComponent(String(providerSubscriptionId || "").trim());
      return request(`/api/console/billing/subscriptions/${encodedSubscriptionId}/cancel-at-period-end`, {
        method: "POST",
        body: payload,
        headers: buildOptionalIdempotencyHeaders(options, {
          required: true
