...
- [`ai-agent/assistant-fastify-routes/README.md`](../../packages/ai-agent/assistant-fastify-routes/README.md)
...
- [`billing/billing-fastify-routes/README.md`](../../packages/billing/billing-fastify-routes/README.md)
...
- [`runtime/health-fastify-routes/README.md`](../../packages/runtime/health-fastify-routes/README.md)
...
- [`workspace/console-errors-fastify-routes/README.md`](../../packages/workspace/console-errors-fastify-routes/README.md)
- [`workspace/console-fastify-routes/README.md`](../../packages/workspace/console-fastify-routes/README.md)
- [`workspace/settings-fastify-routes/README.md`](../../packages/workspace/settings-fastify-routes/README.md)
...
- `GET /api/console/billing/entitlement-definitions`
- `GET /api/console/billing/entitlement-definitions/:definitionId`
...
- `GET /api/workspace/social/feed`
- `POST /api/workspace/social/posts`
- `GET /api/workspace/social/posts/:postId`
- `PATCH /api/workspace/social/posts/:postId`
- `DELETE /api/workspace/social/posts/:postId`
- `POST /api/workspace/social/posts/:postId/comments`
- `DELETE /api/workspace/social/comments/:commentId`
- `POST /api/workspace/social/follows`
- `DELETE /api/workspace/social/follows/:followId`
- `GET /api/workspace/social/actors/search`
- `GET /api/workspace/social/actors/:actorId`
- `GET /api/workspace/social/notifications`
- `POST /api/workspace/social/notifications/read`
- `GET /api/workspace/admin/social/moderation/rules`
- `POST /api/workspace/admin/social/moderation/rules`
- `DELETE /api/workspace/admin/social/moderation/rules/:ruleId`
