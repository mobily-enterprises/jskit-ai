<template>
  <section class="workspace-members-view py-2 py-md-4">
    <v-row>
      <v-col cols="12" lg="5">
...
const { inviteMessage, inviteMessageType, teamMessage, teamMessageType, revokeInviteId } = toRefs(feedback);
...
const { inviteRoles: inviteRoleOptions, memberRoles: memberRoleOptions, formatDateTime } = options;
