...
const DEFAULT_TOP_LEFT_ACTIONS = Object.freeze([
  ...
  Object.freeze({ label: "Dashboard", to: "/app", variant: "text", color: "secondary" })
]);

const DEFAULT_TOP_RIGHT_ACTIONS = Object.freeze([
  Object.freeze({ label: "Alerts", to: "/console", variant: "text", color: "secondary" }),
  Object.freeze({ label: "Settings", to: "/admin", variant: "text", color: "secondary" })
]);
...
export function useSurfaceShell({ topLeftActions, topRightActions, menuItems } = {}) {
