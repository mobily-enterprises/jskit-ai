...
Generate CRUD route trees from an explicit route root under `src/pages/...`.

## Mental Model

This generator follows the same file-driven model as `@jskit-ai/ui-generator`.

- You point at one explicit route root under `src/pages/...`.
...
- `src/pages/admin/catalog/(nestedChildren)/products/[recordId]/index.vue`
- `src/pages/admin/catalog/(nestedChildren)/products/new.vue`
- `src/pages/admin/catalog/(nestedChildren)/products/[recordId]/edit.vue`
- `src/pages/admin/catalog/(nestedChildren)/products/_components/...`
...
If the list page sits under a parent page upgraded with `add-subpages`, the generated list-page link defaults to:

- the parent host's real `host:position`
...
- index-route parent child: `src/pages/admin/catalog/(nestedChildren)/products`
- file-route parent child: `src/pages/admin/customers/[customerId]/orders`
- top-level route: `src/pages/admin/products`
