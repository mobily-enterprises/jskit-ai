...
description: "Compose workspace selection, invitation, member administration, settings, and responsive navigation using JSKIT workspace web APIs."
---

<!-- Generated by `npm run agent-docs:build` from `packages/workspaces-web/patterns/workspace-surfaces/PATTERN.md`. Do not edit manually. -->
