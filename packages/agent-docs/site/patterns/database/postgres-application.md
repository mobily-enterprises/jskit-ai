...
description: "Configure a JSKIT application for PostgreSQL with a fixed driver, ordinary environment values, and rebuildable Knex migrations."
---

<!-- Generated by `npm run agent-docs:build` from `packages/database-runtime-postgres/patterns/postgres-application/PATTERN.md`. Do not edit manually. -->
