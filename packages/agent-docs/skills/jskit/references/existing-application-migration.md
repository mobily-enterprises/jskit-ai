<!-- Generated from `packages/agent-docs/site/guide/app-setup/existing-application-migration.md` by `npm run agent-docs:build`. -->
...
Use the [bundled source pattern index](pattern-index.md) and installed package
