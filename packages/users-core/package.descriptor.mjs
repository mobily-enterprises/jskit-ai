export default Object.freeze({
  ...
  mutations: {
    dependencies: {
      runtime: {
        "@jskit-ai/auth-core": "0.1.87",
        "@jskit-ai/crud-core": "0.1.96",
        "@jskit-ai/database-runtime": "0.1.88",
        "@jskit-ai/http-runtime": "0.1.87",
        "@jskit-ai/json-rest-api-core": "0.1.33",
        "@jskit-ai/kernel": "0.1.88",
        "@jskit-ai/resource-core": "0.1.33",
        "@jskit-ai/resource-crud-core": "0.1.33",
        "@local/users": "file:packages/users",
        "@jskit-ai/uploads-runtime": "0.1.66"
      },
      dev: {}
    },
    packageJson: {
