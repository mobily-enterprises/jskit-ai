import { AppError, registerBootstrapPayloadContributor } from "@jskit-ai/kernel/server/runtime";
...
export { registerWorkspaceBootstrap, createWorkspaceBootstrapContributor };
