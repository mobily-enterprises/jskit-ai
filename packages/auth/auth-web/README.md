...
Fastify HTTP adapter for authentication endpoints plus web login/sign-out scaffolds for JSKIT web-shell apps.

## What this package is for

Use this package to expose auth features over HTTP (register, login, logout, password reset, OTP, OAuth callbacks) and install the default login/sign-out client runtime/view files.
