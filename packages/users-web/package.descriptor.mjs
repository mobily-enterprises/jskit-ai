    ...
    text: [
      {
        ...
        value: "\naddPlacement({\n  id: \"users.workspace.selector\",\n  host: \"shell-layout\",\n  position: \"top-left\",\n  surfaces: [\"*\"],\n  order: 200,\n  componentToken: \"users.web.workspace.selector\",\n  props: {\n    allowOnNonWorkspaceSurface: true,\n    targetSurfaceId: \"app\"\n  },\n  when: ({ auth }) => {\n    return Boolean(auth?.authenticated);\n  }\n});\n\naddPlacement({\n  id: \"users.workspace.tools.widget\",\n  host: \"shell-layout\",\n  position: \"top-right\",\n  surfaces: [\"admin\"],\n  order: 900,\n  componentToken: \"users.web.workspace.tools.widget\"\n});\n\naddPlacement({\n  id: \"users.workspace.menu.workspace-settings\",\n  host: \"workspace-tools\",\n  position: \"primary-menu\",\n  surfaces: [\"admin\"],\n  order: 100,\n  componentToken: \"users.web.workspace-settings.menu-item\",\n  when: ({ permissions }) => {\n    const source = Array.isArray(permissions) ? permissions : [];\n    return (\n      source.includes(\"*\") ||\n      source.includes(\"workspace.settings.view\") ||\n      source.includes(\"workspace.settings.update\")\n    );\n  }\n});\n\naddPlacement({\n  id: \"users.workspace.menu.members\",\n  host: \"workspace-tools\",\n  position: \"primary-menu\",\n  surfaces: [\"admin\"],\n  order: 200,\n  componentToken: \"users.web.workspace-members.menu-item\",\n  when: ({ permissions }) => {\n    const source = Array.isArray(permissions) ? permissions : [];\n    return (\n      source.includes(\"*\") ||\n      source.includes(\"workspace.members.view\") ||\n      source.includes(\"workspace.members.manage\")\n    );\n  }\n});\n",
