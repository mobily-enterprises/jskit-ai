...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await request.executeAction({
        actionId: "crud.google_rewarded_watch_sessions.list",
        input: listInput
      });
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.google_rewarded_watch_sessions.view",
        input: {
          ...buildWorkspaceInputFromRouteParams(request.input.params),
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.google_rewarded_watch_sessions.create",
        input: {
          ...buildWorkspaceInputFromRouteParams(request.input.params),
          ...(request.input.body || {})
        }
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.google_rewarded_watch_sessions.update",
        input: {
          ...buildWorkspaceInputFromRouteParams(request.input.params),
          recordId: request.input.params.recordId,
          ...(request.input.body || {})
  ...
  router.register(
    ...
    async function (request, reply) {
      const response = await request.executeAction({
        actionId: "crud.google_rewarded_watch_sessions.delete",
        input: {
          ...buildWorkspaceInputFromRouteParams(request.input.params),
          recordId: request.input.params.recordId
        }
