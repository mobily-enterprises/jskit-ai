...
function buildTemplateReplacements({
  ...
  return Object.freeze([
    ...
    ["__JSKIT_CRUD_CREATE_ACTION_INPUT_VALIDATOR__", surfaceRequiresWorkspace
      ? '[workspaceSlugParamsValidator, { payload: resource.operations.create.body }]'
    ...
    ["__JSKIT_CRUD_UPDATE_ACTION_INPUT_VALIDATOR__", surfaceRequiresWorkspace
      ? '[workspaceSlugParamsValidator, recordIdParamsValidator, { patch: resource.operations.patch.body }]'
      : "[recordIdParamsValidator, { patch: resource.operations.patch.body }]"],
    ...
    ["__JSKIT_CRUD_VIEW_ROUTE_PARAMS_VALIDATOR_LINE__", surfaceRequiresWorkspace ? "      params: [routeParamsValidator, recordIdParamsValidator]," : "      params: recordIdParamsValidator,"],
    ["__JSKIT_CRUD_CREATE_ROUTE_PARAMS_VALIDATOR_LINE__", surfaceRequiresWorkspace ? "      params: routeParamsValidator," : ""],
    ["__JSKIT_CRUD_UPDATE_ROUTE_PARAMS_VALIDATOR_LINE__", surfaceRequiresWorkspace ? "      params: [routeParamsValidator, recordIdParamsValidator]," : "      params: recordIdParamsValidator,"],
    ["__JSKIT_CRUD_DELETE_ROUTE_PARAMS_VALIDATOR_LINE__", surfaceRequiresWorkspace ? "      params: [routeParamsValidator, recordIdParamsValidator]," : "      params: recordIdParamsValidator,"],
