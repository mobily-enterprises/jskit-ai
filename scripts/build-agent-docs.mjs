...
function renderPatternIndex(patterns, commandName) {
  const lines = [
  ...
  for (const pattern of patterns) {
    ...
    lines.push(`- Read: \`node_modules/${pattern.packageId}/${pattern.documentPath}\``);
    lines.push(`- Examples: \`node_modules/${pattern.packageId}/${pattern.examplePath}/\``);
