...
test("prepared CRUD, calendar-date, and toolchain manifests pin one exact dependency graph", async () => {
  ...
  assert.equal(authCore.version, "0.1.146");
  assert.equal(httpRuntime.version, "0.1.146");
  assert.equal(usersCore.version, "0.1.161");
  assert.equal(usersWeb.version, "0.1.165");
  ...
  assert.equal(crudCore.version, "0.1.158");
  assert.equal(databaseRuntime.version, "0.1.147");
  assert.equal(databaseRuntimeMysql.version, "0.1.146");
  assert.equal(databaseRuntimeMysql.dependencies["@jskit-ai/database-runtime"], databaseRuntime.version);
  assert.equal(databaseRuntimePostgres.version, "0.1.145");
  assert.equal(databaseRuntimePostgres.dependencies["@jskit-ai/database-runtime"], databaseRuntime.version);
  assert.equal(jsonRestApiCore.version, "0.1.92");
  ...
  assert.equal(crudServerGenerator.version, "0.1.160");
  ...
  assert.equal(crudUiGenerator.version, "0.1.131");
  assert.equal(crudUiGenerator.dependencies["@jskit-ai/crud-core"], crudCore.version);
  assert.equal(featureServerGenerator.version, "0.1.90");
  ...
  assert.equal(catalog.version, "0.1.169");
  assert.equal(cli.version, "0.2.175");
  assert.equal(cli.dependencies["@jskit-ai/jskit-catalog"], catalog.version);
  assert.equal(createApp.version, "0.1.167");
