<template>
  <section class="console-invitations-view py-2 py-md-4">
    <v-card rounded="lg" elevation="1" border>
      <v-card-item>
        <v-card-title class="text-h6">Console invitations</v-card-title>
        <v-card-subtitle>Accept or refuse pending console-surface invites.</v-card-subtitle>
      </v-card-item>
      <v-divider />
      <v-card-text>
...
import { useConsoleInvitationsView } from "./useConsoleInvitationsView.js";

const { feedback, selection, collections, actions } = useConsoleInvitationsView();
