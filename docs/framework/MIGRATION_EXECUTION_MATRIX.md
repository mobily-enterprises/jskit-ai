...
| `@jskit-ai/assistant-fastify-routes` | `packages/ai-agent/assistant-fastify-routes` | 11 | pending |  |
...
| `@jskit-ai/billing-fastify-routes` | `packages/billing/billing-fastify-routes` | 12 | pending |  |
...
| `@jskit-ai/console-errors-fastify-routes` | `packages/workspace/console-errors-fastify-routes` | 10 | pending |  |
| `@jskit-ai/console-fastify-routes` | `packages/workspace/console-fastify-routes` | 10 | pending |  |
...
| `@jskit-ai/health-fastify-routes` | `packages/runtime/health-fastify-routes` | 10 | pending |  |
...
| `@jskit-ai/settings-fastify-routes` | `packages/workspace/settings-fastify-routes` | 10 | pending |  |
